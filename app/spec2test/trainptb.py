...
def main():
    ...
    parser.add_argument('--word_vector', '-m', default='word_vector.npz',
    ...
    # Evaluate the final word_vector
    print('test')
    ...
    # Serialize the final word_vector
